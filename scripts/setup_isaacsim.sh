...
echo -e "${C_CYAN}${C_BOLD}[Step 1/3] Running Isaac Sim assets setup...${C_RESET}"
...
# ---------------------------------------------------------
echo -e "\n${C_CYAN}${C_BOLD}[Step 2/3] Installing Mid-360 LiDAR asset...${C_RESET}"
...
# ---------------------------------------------------------
# Step 3: Configure 'agisim' alias in ~/.bashrc
# ---------------------------------------------------------
echo -e "\n${C_CYAN}${C_BOLD}[Step 3/3] Configuring 'agisim' alias in ~/.bashrc...${C_RESET}"
